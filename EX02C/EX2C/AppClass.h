...
class Application
{
	...
	vector3 m_v3Object; //position

	MyRigidBody* m_pObject1 = nullptr; //Rigid Body of the model
	MyRigidBody* m_pObject2 = nullptr; //Rigid Body of the model

	String m_sObject1 = "ARBBTest.obj";
	String m_sObject2 = "ARBBTest.obj";
...
public:
	bool IsClose(vector3 a_v3A, vector3 a_v3B, float epsilon = 0.001f);
