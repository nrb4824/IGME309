...
void Application::DrawGUI(void)
{
	...
	//About
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::Text("G: Hide/Show Grid");
			ImGui::Text("Up/Down: Change Height");
			ImGui::Text("Left/Right: Change radius");
			ImGui::Text("+/-: Change Subdivisions");
			ImGui::TextColored(v4Color, "Arcball will override matrix transform!");
		}
		ImGui::End();
	}
