...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::Escape:
		...
		break;
	case sf::Keyboard::F1:
		m_pCameraMngr->SetCameraMode(BTXs::eCAMERAMODE::CAM_PERSP);
		break;
	case sf::Keyboard::F2:
		m_pCameraMngr->SetCameraMode(BTXs::eCAMERAMODE::CAM_ORTHO_Z);
		break;
	case sf::Keyboard::F3:
		m_pCameraMngr->SetCameraMode(BTXs::eCAMERAMODE::CAM_ORTHO_Y);
		break;
	case sf::Keyboard::F4:
		m_pCameraMngr->SetCameraMode(BTXs::eCAMERAMODE::CAM_ORTHO_X);
		break;
	case sf::Keyboard::Add:
		m_uSub++;
		m_pPencil->GeneratePencil(m_uSub, m_fRadius, m_fHeight);
		break;
