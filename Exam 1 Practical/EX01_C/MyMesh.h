...
public:
	...
	*/
	...
	OUTPUT: ---
	*/
	void AddTri(vector3 a_vBottomLeft, vector3 a_vBottomRight, vector3 a_vTopLeft, vector3 a_v3Color);
	/*
	...
	OUTPUT: ---
	*/
	void AddQuad(vector3 a_vBottomLeft, vector3 a_vBottomRight, vector3 a_vTopLeft, vector3 a_vTopRight, vector3 a_v3Color);
#pragma region 3D Primitives
	...
	*/
	...
	void GeneratePencil(uint a_uSubdivisions, float a_fRadius = 1.0f, float a_fHeight = 1.5f);
#pragma endregion
};
