...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::RShift:
		...
		break;
	case sf::Keyboard::C:
		m_bCameraSwitch = !m_bCameraSwitch;
...
#pragma region Camera Position
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
		m_qArcBall = m_qArcBall * glm::angleAxis(glm::radians(-1.0f), AXIS_X);
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::A))
		m_qArcBall = m_qArcBall * glm::angleAxis(glm::radians(1.0f), AXIS_Y);

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::D))
		m_qArcBall = m_qArcBall * glm::angleAxis(glm::radians(-1.0f), AXIS_Y);

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Q))
		m_qArcBall = m_qArcBall * glm::angleAxis(glm::radians(-1.0f), AXIS_Z);
