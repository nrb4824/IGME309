...
class Application
{
	Space* m_pRoot = nullptr;//Root of the octree
	uint m_uNodeID = -1; //Index of Octant to display
	uint m_uObjects = 0; //Number of objects in the scene
	uint m_uGridWidth = 1; //Number of levels in the grid
	uint m_uGridHeight = 1; //Number of levels in the grid
