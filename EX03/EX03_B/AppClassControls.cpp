...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::PageUp:
		++m_uNodeID;
		if (m_uNodeID >= m_pRoot->GetSpaceCount())
			m_uNodeID = -1;
		break;
...
#pragma region Character Position
	...
	{
		m_pEntityMngr->ApplyForce(vector3(-2.0f * fDelta, 0.0f, 0.0f), "Cube");
	}
	...
	{
		m_pEntityMngr->ApplyForce(vector3(0.0f, 20.0f * fDelta, 0.0f), "Cube");
	}
#pragma endregion
}
//Mouse
